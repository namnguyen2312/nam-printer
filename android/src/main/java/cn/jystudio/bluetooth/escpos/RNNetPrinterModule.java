...
import cn.jystudio.bluetooth.escpos.adapter.NetPrinterAdapter;
import cn.jystudio.bluetooth.escpos.adapter.NetPrinterDeviceId;
import cn.jystudio.bluetooth.escpos.adapter.PrinterAdapter;
...
public class RNNetPrinterModule extends ReactContextBaseJavaModule implements RNPrinterModule {
    ...
    public void printImageBase64(String base64, int imageWidth, int imageHeight, Callback errorCallback) {
        ...
        Log.v("base64", base64);
        Log.v("decodedByte", decodedByte.toString());
