package cn.jystudio.bluetooth.escpos.adapter;
import static cn.jystudio.bluetooth.escpos.adapter.UtilsImage.getPixelsSlow;
import static cn.jystudio.bluetooth.escpos.adapter.UtilsImage.recollectSlice;
...
//                    Log.d("IPAddress", "IP Address: " + ipAddress);
    ...
    public void printRawData(String rawBase64Data, Callback errorCallback) {
        ...
        Log.v(LOG_TAG, "start to print text raw data " + rawBase64Data);
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    Log.e(LOG_TAG, " printRawData failed to print data" + rawData);
                    e.printStackTrace();
                }
            }
        }).start();
